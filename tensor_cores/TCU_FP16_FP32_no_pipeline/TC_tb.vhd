...
-- state machine loading the patterns and applying to the DUT: (Dot Product Unit) DPU
	...
	test_bench : process
		...
		file text_file : TEXT open READ_MODE is "General_TC_FP_hex_patterns.txt";  -- check this address during importing
		
		variable text_line : line;
		variable ok : boolean;
		variable char : character;

		variable A_hex_00_text : std_logic_vector(15 downto 0);
		variable A_hex_01_text : std_logic_vector(15 downto 0);
		variable A_hex_02_text : std_logic_vector(15 downto 0);
		variable A_hex_03_text : std_logic_vector(15 downto 0);
		variable A_hex_10_text : std_logic_vector(15 downto 0);
		variable A_hex_11_text : std_logic_vector(15 downto 0);
		variable A_hex_12_text : std_logic_vector(15 downto 0);
		variable A_hex_13_text : std_logic_vector(15 downto 0);
		variable A_hex_20_text : std_logic_vector(15 downto 0);
		variable A_hex_21_text : std_logic_vector(15 downto 0);
		variable A_hex_22_text : std_logic_vector(15 downto 0);
		variable A_hex_23_text : std_logic_vector(15 downto 0);
		variable A_hex_30_text : std_logic_vector(15 downto 0);
		variable A_hex_15_text : std_logic_vector(15 downto 0);
		variable A_hex_32_text : std_logic_vector(15 downto 0);
		variable A_hex_33_text : std_logic_vector(15 downto 0);
		
		variable B_hex_00_text : std_logic_vector(15 downto 0);
		variable B_hex_01_text : std_logic_vector(15 downto 0);
		variable B_hex_02_text : std_logic_vector(15 downto 0);
		variable B_hex_03_text : std_logic_vector(15 downto 0);
		variable B_hex_10_text : std_logic_vector(15 downto 0);
		variable B_hex_11_text : std_logic_vector(15 downto 0);
		variable B_hex_12_text : std_logic_vector(15 downto 0);
		variable B_hex_13_text : std_logic_vector(15 downto 0);
		variable B_hex_20_text : std_logic_vector(15 downto 0);
		variable B_hex_21_text : std_logic_vector(15 downto 0);
		variable B_hex_22_text : std_logic_vector(15 downto 0);
		variable B_hex_23_text : std_logic_vector(15 downto 0);
		variable B_hex_30_text : std_logic_vector(15 downto 0);
		variable B_hex_15_text : std_logic_vector(15 downto 0);
		variable B_hex_32_text : std_logic_vector(15 downto 0);
		variable B_hex_33_text : std_logic_vector(15 downto 0);
