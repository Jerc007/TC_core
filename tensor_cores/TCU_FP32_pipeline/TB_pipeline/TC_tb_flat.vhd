...
-- state machine loading the patterns and applying to the DUT: (Dot Product Unit) DPU
	...
	test_bench : process
		...
		file text_file : TEXT open READ_MODE is "General_TC_FP_hex_patterns.txt";

		variable text_line : line;
		variable ok : boolean;
		variable char : character;

		variable A0_hex_a0_text : std_logic_vector(31 downto 0);
		variable A0_hex_a1_text : std_logic_vector(31 downto 0);
		variable A0_hex_a2_text : std_logic_vector(31 downto 0);
		variable A0_hex_a3_text : std_logic_vector(31 downto 0);

		variable A1_hex_a0_text : std_logic_vector(31 downto 0);
		variable A1_hex_a1_text : std_logic_vector(31 downto 0);
		variable A1_hex_a2_text : std_logic_vector(31 downto 0);
		variable A1_hex_a3_text : std_logic_vector(31 downto 0);

		variable A2_hex_a0_text : std_logic_vector(31 downto 0);
		variable A2_hex_a1_text : std_logic_vector(31 downto 0);
		variable A2_hex_a2_text : std_logic_vector(31 downto 0);
		variable A2_hex_a3_text : std_logic_vector(31 downto 0);

		variable A3_hex_a0_text : std_logic_vector(31 downto 0);
		variable A3_hex_a1_text : std_logic_vector(31 downto 0);
		variable A3_hex_a2_text : std_logic_vector(31 downto 0);
		variable A3_hex_a3_text : std_logic_vector(31 downto 0);

		variable B0_hex_b0_text : std_logic_vector(31 downto 0);
		variable B0_hex_b1_text : std_logic_vector(31 downto 0);
		variable B0_hex_b2_text : std_logic_vector(31 downto 0);
		variable B0_hex_b3_text : std_logic_vector(31 downto 0);

		variable B1_hex_b0_text : std_logic_vector(31 downto 0);
		variable B1_hex_b1_text : std_logic_vector(31 downto 0);
		variable B1_hex_b2_text : std_logic_vector(31 downto 0);
		variable B1_hex_b3_text : std_logic_vector(31 downto 0);

		variable B2_hex_b0_text : std_logic_vector(31 downto 0);
		variable B2_hex_b1_text : std_logic_vector(31 downto 0);
		variable B2_hex_b2_text : std_logic_vector(31 downto 0);
		variable B2_hex_b3_text : std_logic_vector(31 downto 0);

		variable B3_hex_b0_text : std_logic_vector(31 downto 0);
		variable B3_hex_b1_text : std_logic_vector(31 downto 0);
		variable B3_hex_b2_text : std_logic_vector(31 downto 0);
		variable B3_hex_b3_text : std_logic_vector(31 downto 0);
