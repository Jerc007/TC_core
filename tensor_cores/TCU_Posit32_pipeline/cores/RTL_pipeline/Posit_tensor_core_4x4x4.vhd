...
architecture ar of tensor_core_unit is
	...
	signal valid_out00 : std_logic;
	signal valid_out01 : std_logic;
	signal valid_out02 : std_logic;
	signal valid_out03 : std_logic;
	signal valid_out10 : std_logic;
	signal valid_out11 : std_logic;
	signal valid_out12 : std_logic;
	signal valid_out13 : std_logic;
	signal valid_out20 : std_logic;
	signal valid_out21 : std_logic;
	signal valid_out22 : std_logic;
	signal valid_out23 : std_logic;
	signal valid_out30 : std_logic;
	signal valid_out31 : std_logic;
	signal valid_out32 : std_logic;
	signal valid_out33 : std_logic;
	
	
begin
	
	valid_out <= (((valid_out00 and valid_out01) and (valid_out02 and valid_out03)) and ((valid_out10 and valid_out11) and (valid_out12 and valid_out13))) and (((valid_out20 and valid_out21) and (valid_out22 and valid_out23)) and ((valid_out30 and valid_out31) and (valid_out32 and valid_out33)));
