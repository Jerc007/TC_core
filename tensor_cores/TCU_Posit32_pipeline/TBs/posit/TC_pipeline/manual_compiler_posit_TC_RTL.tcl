...
set cores_vhdls [list \
	...
	"# TB - Top-level" \
	"../../../cores/RTL_pipeline/PositAdder.vhd" \
	"../../../cores/RTL_pipeline/PositMult.vhd" \
	"../../../cores/RTL_pipeline/dot_unit_core.vhd" \
	"../../../cores/RTL_pipeline/Posit_tensor_core_4x4x4.vhd" \
	"TC_tb.vhd" \
]
...
vcd add -file Posit_TC.vcd -ports TC_core_TB/TCU0/*
